...
public class Main {
    public static final GameProcessor gameProcessor = new GameProcessor();
    ...
    public static void main(String[] args) {
        ...
        ResourceManager.storage = filesStorage;
        try {
                ...
                new CallbackQueryHandler(
                        ...
                        event -> {
                            ...
                            try {
                                ...
                                Response response = gameProcessor.handleRequest(Request.builder()
                                        .userId(event.userId)
